 ...
 * Generated at: 2018-09-24 01:12:20 UTC
...
public final class workFlowManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<a class=\"layui-btn layui-btn layui-btn\" lay-event=\"add\">添加部署</a>\r\n");
      out.write("</script>\r\n");
      out.write("<!--操作-->\r\n");
      ...
      out.write("    <a class=\"layui-btn layui-btn-xs layui-btn-warm\" lay-event=\"viewProcessImage\">查看流程图</a>\r\n");
      out.write("</script>\r\n");
      ...
      out.write("    var tableInsDeployment;\r\n");
      out.write("    var tableInsProcessDef;\r\n");
      ...
      out.write("        //流程部署列表\r\n");
      out.write("        tableInsDeployment = table.render({\r\n");
      out.write("            elem: '#processDeploymentList',\r\n");
      out.write("            url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/workFlow/loadAllProcessDeployment.action',\r\n");
      ...
      out.write("                {field: 'id', title: '部署ID', minWidth:100, align:\"center\"},\r\n");
      out.write("                {field: 'name', title: '部署名称', minWidth:100, align:\"center\"},\r\n");
      out.write("                {field: 'deploymentTime', title: '部署时间', minWidth:100, align:\"center\"},\r\n");
      out.write("                {title: '操作', minWidth:175, templet:'#processDeploymentListBar',fixed:\"right\",align:\"center\"}\r\n");
      out.write("            ]]\r\n");
      out.write("        });\r\n");
      out.write("        \r\n");
      out.write("      //流程定义列表\r\n");
      out.write("       tableInsProcessDef = table.render({\r\n");
      out.write("            elem: '#processDefList',\r\n");
      out.write("            url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/workFlow/loadAllProcessDef.action',\r\n");
      out.write("            cellMinWidth : 95,\r\n");
      out.write("            toolbar: true,\r\n");
      out.write("            page : true,\r\n");
      out.write("            height : \"full-420\",\r\n");
      out.write("            limits : [10,15,20,25],\r\n");
      out.write("            defaultToolbar: ['filter'],\r\n");
      out.write("            limit : 10,\r\n");
      ...
      out.write("                url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/workFlow/loadAllProcessDeployment.action?'+params\r\n");
      out.write("            });\r\n");
      out.write("            table.reload('processDefListTable', {\r\n");
      out.write("                url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/workFlow/loadAllProcessDef.action?'+params\r\n");
      out.write("            });\r\n");
      out.write("        });\r\n");
      out.write("        //监听头工具栏事件\r\n");
      ...
      out.write("\t            case 'add':\r\n");
      out.write("\t               \ttoAddDeployment();\r\n");
      out.write("                \tbreak;\r\n");
      out.write("            };\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        //打开  添加流程的弹出层\r\n");
      out.write("        function toAddDeployment(){\r\n");
      ...
      out.write("                content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/workFlow/toAddDeployment.action\",\r\n");
      ...
      out.write("                layer.confirm('确定删【'+data.name+'】流程吗？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("                    $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      ...
      out.write("                        //刷新table\r\n");
      out.write("                        tableInsDeployment.reload();\r\n");
      out.write("                        tableInsProcessDef.reload();\r\n");
      out.write("                        //关闭提示框\r\n");
      ...
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("        //打开分配流程的弹出层\r\n");
      out.write("        function  viewProcessImage(data){\r\n");
      out.write("        \tvar index = layui.layer.open({\r\n");
      out.write("                title : \"查看【\"+data.name+\"】的流程图\",\r\n");
      out.write("                type : 2,\r\n");
      out.write("                area:[\"800px\",\"600px\"],\r\n");
      out.write("                content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/workFlow/toViewProcessImage.action?deploymentId=\"+data.id,\r\n");
      out.write("                success : function(layero, index){\r\n");
      out.write("                    setTimeout(function(){\r\n");
      out.write("                        layui.layer.tips('点击此处返回流程列表', '.layui-layer-setwin .layui-layer-close', {\r\n");
      out.write("                            tips: 3\r\n");
