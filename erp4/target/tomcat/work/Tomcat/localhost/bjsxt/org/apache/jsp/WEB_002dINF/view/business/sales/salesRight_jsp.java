 ...
 * Generated at: 2018-09-25 12:53:40 UTC
...
public final class salesRight_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t  </div>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t\t<table id=\"salesList\" lay-filter=\"salesList\"></table>\r\n");
      ...
      out.write("\t\t</script>\r\n");
      out.write("\t\t<!--操作-->\r\n");
      out.write("\t\t<script type=\"text/html\" id=\"salesListBar\">\r\n");
      ...
      out.write("        elem: '#salesList',\r\n");
      out.write("        url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sales/loadSales.action',\r\n");
      ...
      out.write("            {field: 'salestime', title: '销售时间', minWidth:100, align:\"center\"},\r\n");
      out.write("            {field: 'number', title: '销售数量数据', minWidth:100, align:\"center\"},\r\n");
      out.write("            {field: 'salesprice', title: '销售价格', minWidth:100, align:\"center\"},\r\n");
      out.write("            {title: '操作', minWidth:175, templet:'#salesListBar',fixed:\"right\",align:\"center\"}\r\n");
      out.write("        ]]\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("  //监听头工具栏事件\r\n");
      out.write("    table.on('toolbar(salesList)', function(obj){\r\n");
      out.write("        switch(obj.event){\r\n");
      out.write("\t            case 'add':\r\n");
      out.write("\t            \ttoAddSales();\r\n");
      out.write("            \tbreak;\r\n");
      ...
      out.write("    \ttable.reload('salesListTable', {\r\n");
      out.write("    \t\t  url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sales/loadSales.action?'+params\r\n");
      out.write("    \t});\r\n");
      out.write("    });\r\n");
      out.write("   \r\n");
      out.write("    //添加商品\r\n");
      out.write("   function toAddSales(){\r\n");
      out.write("        var index = layui.layer.open({\r\n");
      out.write("            title : \"添加商品销售\",\r\n");
      out.write("            type : 2,//ifream层\r\n");
      out.write("            area:[\"700px\",\"500px\"],\r\n");
      out.write("            content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sales/toAddSales.action\",\r\n");
      ...
      out.write("    }\r\n");
      out.write("    //修改商品\r\n");
      out.write("    function updateSales(data){\r\n");
      out.write("    \tvar index = layui.layer.open({\r\n");
      out.write("            title : \"修改商品销售\",\r\n");
      out.write("            type : 2,\r\n");
      out.write("            area:[\"700px\",\"500px\"],\r\n");
      out.write("            content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sales/toUpdateSales.action?id=\"+data.id,\r\n");
      out.write("            success : function(layero, index){\r\n");
      out.write("                setTimeout(function(){\r\n");
      out.write("                    layui.layer.tips('点击此处返回商品列表', '.layui-layer-setwin .layui-layer-close', {\r\n");
      out.write("                        tips: 3\r\n");
      ...
      out.write("    \r\n");
      out.write("    //列表操作\r\n");
      out.write("    table.on('tool(salesList)', function(obj){\r\n");
      out.write("        var layEvent = obj.event,\r\n");
      out.write("            data = obj.data;\r\n");
      out.write("        if(layEvent === 'edit'){ //编辑\r\n");
      out.write("        \tupdateSales(data);//data主当前点击的行\r\n");
      out.write("        }else if(layEvent === 'del'){ //删除\r\n");
      out.write("            layer.confirm('确定删【'+data.salesname+'】商品吗？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("                 $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sales/deleteSales.action\",{\r\n");
      ...
      out.write("        var checkStatus = table.checkStatus('salesListTable'),//选中状态\r\n");
      ...
      out.write("                 $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sales/batchDeleteSales.action?\"+ids,function(data){\r\n");
      out.write("                \t //刷新table\r\n");
      out.write("                     tableIns.reload();\r\n");
      out.write("                 \t //关闭提示框\r\n");
      out.write("                \tlayer.close(index);\r\n");
      ...
      out.write("            })\r\n");
      out.write("        }else{\r\n");
      out.write("            layer.msg(\"请选择需要删除的商品销售信息\");\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      out.write("})\r\n");
      out.write("//供salesLeft.jsp调用的方法\r\n");
      out.write(" function reloadTable(id){\r\n");
      out.write("\ttableIns.reload({\r\n");
      out.write("\t\t  where: { //设定异步数据接口的额外参数，任意设\r\n");
      out.write("\t\t    customerid: id\r\n");
      out.write("\t\t  }\r\n");
      out.write("\t\t  ,page: {\r\n");
