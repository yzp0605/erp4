 ...
 * Generated at: 2018-09-14 03:27:15 UTC
...
public final class permissionRight_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<title>权限管理--右边的数据表格</title>\r\n");
      ...
      out.write("            url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/loadAllPermission.action',\r\n");
      ...
      out.write("            id : \"permissionListTable\",\r\n");
      out.write("            cols : [[\r\n");
      out.write("                {type: \"checkbox\", fixed:\"left\", width:50},\r\n");
      out.write("                {field: 'id', title: 'ID', width:60, align:\"center\"},\r\n");
      out.write("                {field: 'pid', title: '父级权限ID', width:120, align:\"center\"},\r\n");
      out.write("                {field: 'name', title: '权限名称', width:200, align:\"center\"},\r\n");
      out.write("                {field: 'percode', title: '权限编码',align:\"center\", width:180},\r\n");
      ...
      out.write("\t            case 'add':\r\n");
      out.write("\t               \ttoAddPermission();\r\n");
      out.write("                \tbreak;\r\n");
      out.write("                case 'batchDel':\r\n");
      out.write("                    var checkStatus = table.checkStatus('permissionListTable'),\r\n");
      ...
      out.write("\t                         $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/batchDeletePermission.action\"+ids,function(data){\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("        //打开添加页面\r\n");
      out.write("        function toAddPermission(){\r\n");
      out.write("        \t//打开弹出层\r\n");
      ...
      out.write("                content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/toAddPermission.action\",\r\n");
      out.write("                success : function(layero, index){\r\n");
      out.write("                    var body = layui.layer.getChildFrame('body', index);\r\n");
      out.write("                    setTimeout(function(){\r\n");
      out.write("                        layui.layer.tips('点击此处返回权限列表', '.layui-layer-setwin .layui-layer-close', {\r\n");
      out.write("                            tips: 3\r\n");
      out.write("                        });\r\n");
      out.write("                    },500)\r\n");
      out.write("                }\r\n");
      ...
      out.write("            \ttoUpdate(data.id);//取出权限ID\r\n");
      out.write("            }else if(layEvent === 'del'){ //删除\r\n");
      out.write("                layer.confirm('确定删除此权限？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("                \t $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/deletePermission.action?id=\"+data.id,function(data){\r\n");
      out.write("                \t\tlayer.msg(data.msg);\r\n");
      out.write("                     \ttableIns.reload();\r\n");
      out.write("                     \tlayer.close(index);\r\n");
      out.write("                      })\r\n");
      ...
      out.write("                content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/toUpdatePermission.action?id=\"+id,\r\n");
      out.write("                success : function(layero, index){\r\n");
      out.write("                    var body = layui.layer.getChildFrame('body', index);\r\n");
      out.write("                    setTimeout(function(){\r\n");
      out.write("                        layui.layer.tips('点击此处返回权限列表', '.layui-layer-setwin .layui-layer-close', {\r\n");
