 ...
 * Generated at: 2018-09-15 07:00:02 UTC
...
public final class userUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"ordernum\" lay-verify=\"number\" value=\"");
      ...
      out.write("\" id=\"loginname\"  autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t<textarea placeholder=\"请输入内容\" name=\"remark\" class=\"layui-textarea\">");
      ...
      out.write("\t\t\tvar node = treeObj.getNodeByParam(\"id\", userDeptId, null);//根据id得到应该被选中的节点\r\n");
      ...
      out.write("\";\r\n");
      out.write("\t\t\t//根据领导的ID查询出领导的部门ID\r\n");
      out.write("\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/queryUserById.action\",{id:leaderId},function(obj){\r\n");
      out.write("\t\t\t\tvar leaderDeptId=obj.deptid;\r\n");
      out.write("\t\t\t\tvar leadertreeObj = $.fn.zTree.getZTreeObj(\"leaderdeptidTree\");\r\n");
      out.write("\t\t\t\tvar leadernode = leadertreeObj.getNodeByParam(\"id\", leaderDeptId, null);//根据id得到应该被选中的节点\r\n");
      out.write("\t\t\t\tleadertreeObj.selectNode(leadernode);\r\n");
      out.write("\t\t\t\t//重新渲染\r\n");
      out.write("\t\t\t\tonClick(event,\"leaderdeptidTree\",leadernode);\r\n");
      out.write("\t\t\t},\"json\");\r\n");
      out.write("    \t\t //用户领导部门  并选中领导的名称\r\n");
      out.write("    \t\t \r\n");
      out.write("    \t\t \r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.mgr}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write(";\r\n");
      out.write("    \t\t\tif(leaderId==obj[i].id){\r\n");
      out.write("    \t\t\t\thtml+=\" <option selected value=\"+obj[i].id+\">\"+obj[i].name+\"</option>\"\r\n");
      out.write("    \t\t\t}else{\r\n");
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/view/system/user/userUpdate.jsp(96,61) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/view/system/user/userUpdate.jsp(96,61) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
