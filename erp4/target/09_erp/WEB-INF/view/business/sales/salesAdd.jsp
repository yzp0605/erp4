...
<body class="childrenBody">
	<form class="layui-form" method="post" id="frm">
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select name="customerid" lay-filter="customerid">
						...
						<c:forEach var="sn" items="${customers }">
							<option value="${sn.id }">${sn.customername }</option>
						</c:forEach>
					</select>
				</div>
			</div>
			...
			<div class="layui-inline">
			   ...
			   <div class="layui-inline">
			      ...
			      <div class="layui-input-inline">
			        <input type="tel" name="salestime" id="salestime" autocomplete="off" class="layui-input">
			      </div>
			    </div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="tel" name="inportprice" placeholder="销售价格" lay-verify="required|number" autocomplete="off"
						class="layui-input">
				</div>
			</div>
				<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="operateperson" value="${user.name }">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea placeholder="请输入销售备注" name="remark"
