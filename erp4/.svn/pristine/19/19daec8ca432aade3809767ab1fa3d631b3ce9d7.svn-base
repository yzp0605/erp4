	...
	<form class="layui-form" action="#" method="post" id="frm" lay-filter="frm">
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					...
					<input type="text" name="ordernum" lay-verify="number" value="${dept.ordernum }"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="name" lay-verify="required"  autocomplete="off" value="${dept.name }"
					class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="loc"  autocomplete="off" value="${dept.loc }"
					class="layui-input">
			</div>
		</div>
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea placeholder="请输入内容" name="remark" class="layui-textarea">${dept.remark }</textarea>
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-inline">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="radio" name="parent" value="1" ${dept.parent==1?'checked':'' } lay-filter="parent" title="是" >
					<input type="radio" name="parent" value="0" ${dept.parent==0?'checked':'' } lay-filter="parent" title="否" > 
				</div>
			</div>
			<div class="layui-inline">
